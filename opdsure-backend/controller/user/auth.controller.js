...
const UserAuthController = {
  ...
  SignUpOtp: async (req, res) => {
    const body = req.body;
    const data = await UserService.SignUpOtp(body);
    ResponseHandler(res, StatusCodes.OK, data, true, CONSTANTS_MESSAGES.SUCCESS);
  },
  LoginInOtp: async (req, res) => {
    const body = req.body;
    const data = await UserService.LoginInOtp(body);
    ResponseHandler(res, StatusCodes.OK, data, true, CONSTANTS_MESSAGES.SUCCESS);
  },
  ...
  VerifySignUpOtp: async (req, res) => {
    const body = req.body;
    const data = await UserService.VerifySignUpOtp(body);
    ResponseHandler(res, StatusCodes.OK, data, true, CONSTANTS_MESSAGES.SUCCESS);
  },
