...
const UserController = {
    ...
    ReferUser: async (req, res) => {
        const data = await UserService.AddReferUsers( req.user._id, req.body, req.user );
        ResponseHandler(res, StatusCodes.OK, data, true, CONSTANTS_MESSAGES.SUCCESS);
    },

    GetAllReferUsers: async (req, res) => {
        const data = await UserService.GetReferedUsers( req.user._id, req.body );
        ResponseHandler(res, StatusCodes.OK, data, true, CONSTANTS_MESSAGES.SUCCESS);
    },
  ...
  GetPurchasedHealthCheckupPlans: async (req,res) => {
    const data = await UserService.GetPurchasedHealthCheckupPlans(req.user._id,req.query)
    ResponseHandler(res, StatusCodes.OK, data, true, CONSTANTS_MESSAGES.SUCCESS);
  },

    GetRequestedMembers: async (req, res) => {
        const data = await UserService.GetRequestedMembers(req.user._id)
        ResponseHandler(res, StatusCodes.OK, data, true, CONSTANTS_MESSAGES.SUCCESS);
    },

    GetNotifications: async (req,res) => {
        const data = await UserService.GetNotifications(req.user._id,req.query)
        ResponseHandler(res, StatusCodes.OK, data, true, CONSTANTS_MESSAGES.SUCCESS);
    },

    DeleteNotification: async (req,res) => {
        const data = await UserService.DeleteNotification(req.user._id,req.params.id)
        ResponseHandler(res, StatusCodes.OK, data, true, CONSTANTS_MESSAGES.SUCCESS);
    },

    GetAllReferUsers: async (req, res) => {
        const data = await UserService.GetAllReferedUsers(req.user._id,req.query);
        ResponseHandler(res, StatusCodes.OK, data, true, CONSTANTS_MESSAGES.SUCCESS);  
      },

    MfineRedirect: async (req, res) => {
        const data = await UserService.MfineRedirect(req.user);
        ResponseHandler(res, StatusCodes.OK, data, true, CONSTANTS_MESSAGES.SUCCESS);  
      },
      GetHealthTest: async (req, res) => {
        const data = await UserService.GetHealthTest(req.user._id);
        ResponseHandler(res, StatusCodes.OK, data, true, CONSTANTS_MESSAGES.SUCCESS);  
      },
      AddHTCollectionDetails: async (req, res) => {
        const data = await UserService.AddHTCollectionDetails(req.user._id,req.body);
        ResponseHandler(res, StatusCodes.OK, data, true, CONSTANTS_MESSAGES.SUCCESS);  
      },
      AddPreviousHTCollectionDetails: async (req, res) => {
        const data = await UserService.AddPreviousHTCollectionDetails(req.params.id,req.body);
        ResponseHandler(res, StatusCodes.OK, data, true, CONSTANTS_MESSAGES.SUCCESS);  
      },
