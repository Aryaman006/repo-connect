...
const HRCorpoEmpBulkUpload = ({organization}) => {
...
const handleUpload = (file) => {
  ...
  const handleBulkUpload = async () => {
    ...
    try {
      const response = await Axios.postAxiosData(config.HrAddCorpoEmpBulk, payload);
  ...
  const handleDeleteBulk = async () => {
      const response = await Axios.deleteAxiosData(config.HrDeleteFailedCorpoInserts);
      if (response.success === true) {
...
export default HRCorpoEmpBulkUpload;
