...
const ContactUsRetailEmply = () => {
  ...
  const fetchAll = async () => {
    ...
    try {
      const response = await Axios.fetchAxiosData(config.GetContactUsRetailbyempl, {
        params: {
  ...
  const fetchAllList = async () => {
    ...
    try {
      const response = await Axios.fetchAxiosData(config.GetContactUsRetailListbyempl, {   
      });
...
export default ContactUsRetailEmply