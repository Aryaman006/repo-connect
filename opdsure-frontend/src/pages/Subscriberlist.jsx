...
const SubscriberListEmpl = () => {
  const columns = [
    ...
    //         <EyeOutlined style={{ color: "blue", marginRight: "0rem" }} />
    //       </Link>
    //     </div>
    //   ),
    // },
  ...
  const fetchSubscriber = async () => {
    const response = await Axios.fetchAxiosData(
      config.GetRegisteredUsersbyempl,
    );
...
export default SubscriberListEmpl;
