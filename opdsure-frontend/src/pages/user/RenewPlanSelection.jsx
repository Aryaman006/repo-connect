...
const RenewPlanSelection = () => {
  ...
  const onPlanTypeChange = (value, cardIndex) => {
   ...
   const handleOk = () => {
    ...
    navigate("/user/payment/renew-plan", { state: { plan_values :{agreedTerms , plan_id,plan_name, selectedCard, membership_id: cardStates[selectedCard?.cardIndex]?.selectedPlan , planType: cardStates[selectedCard?.cardIndex]?.selectedPlanLabel, planPrice: cardStates[selectedCard?.cardIndex]?.selectedPlanPrice}} });
  };
...
export default RenewPlanSelection;