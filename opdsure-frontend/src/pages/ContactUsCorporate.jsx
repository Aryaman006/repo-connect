...
const ContactUsCorporateEmply = () => {
  ...
  const fetchAll = async () => {
    ...
    try {
      const response = await Axios.fetchAxiosData(config.GetContactUsCorporatebyempl, {
        params: {
  ...
  const fetchAllList = async () => {
    ...
    try {
      const response = await Axios.fetchAxiosData(config.GetContactUsCorporateListbyempl, {
      });
...
export default ContactUsCorporateEmply