...
const AdminClaimDetails = () => {
  ...
  const fetchData = async () => {
    let url;
      ...
      url = config.GetClaimsAdminDetails + id
  ...
  const handlePayClaim = async (id) => {
    confirm({
      title: <h4 className="textblue">Confirmation !</h4>,
      content: <div>
        <p>Are you sure you want to Pay <span className="fw-bold textblue">₹&nbsp;{allDetails?.claimable_amount}</span>&nbsp; amount?</p>
        </div>,
      icon: <ExclamationCircleFilled />,
      centered: true,
      async onOk() {
      ...
      if(result.success===true){
        ...
        notification.error({
          message: "Failed to rtelease payment"
        })
      }
    },
    onCancel() {},
  ...
  return (
    <div className="container">
      ...
      <div className="row rounded-2 p-2">
        ...
        <div className="row rounded-2 p-2">
        <div className="col-2  my-auto fw-bold">
            <p className="my-auto">Pharmacy bill:</p>
          </div>
          <div className="col-4">
        ...
        <div className="row rounded-2 p-2">
        <div className="col-2  my-auto fw-bold">
            <p className="my-auto">Diagnostics Bill:</p>
          </div>
          <div className="col-4">
        ...
        <div className="row rounded-2 p-2">
        <div className="col-2  my-auto fw-bold">
            <p className="my-auto">Approved Pharmacy bill:</p>
          </div>
          <div className="col-4">
        ...
        <div className="row rounded-2 p-2">
        <div className="col-2  my-auto fw-bold">
            <p className="my-auto">Approved Diagnostics Bill:</p>
          </div>
          <div className="col-4">
      ...
      {/* {(localStorage.getItem("user_type") === "0" && allDetails?.status !== 12)? (
        <div className="d-flex justify-content-end m-2">
          <button className="btn btn-outline-primary" onClick={() => {
              ...
              setApprovedPharmacyTestFee(allDetails?.approved_claimable_combined_pharmacy_test_fees || 0);
              setShowModal(true);
            }}>
            Edit Claim Bill
          </button>
...
{showModal && (
  <div className="modal show d-block" tabIndex="-1">
    <div className="modal-dialog">
      <div className="modal-content">
        ...
        <div className="modal-body">
          <div className="mb-3">
            ...
            <input type="number" className="form-control" value={approvedDoctorFee} onChange={(e) => setApprovedDoctorFee(e.target.value)} />
          </div>
          <div className="mb-3">
            <label className="form-label">Diagnostics Bill</label>
            <input type="number" className="form-control" value={approvedPharmacyFee} onChange={(e) => setApprovedPharmacyFee(e.target.value)} />
          </div>
          <div className="mb-3">
            <label className="form-label">Pharmacy bill</label>
            <input type="number" className="form-control" value={approvedLabFee} onChange={(e) => setApprovedLabFee(e.target.value)} />
          </div>
        
          <div className="mb-3">
            <label className="form-label">Total Claimable Amount</label>
            <input type="number" className="form-control" value={approvedClaimableAmount.toFixed(2)} disabled />
          </div>
        </div>
      ...
      {/* {
        (internalDesignation === CONSTANTS.DESIGNATIONS[4].internal_id || internalDesignation === CONSTANTS.DESIGNATIONS[2].internal_id) && 
        (internalStatus===CONSTANTS.CLAIM_STATUS.INTERNAL_STATUS.APPROVED) ?
        <>
         <Row justify="end">
           <Button
      ...
      <Row justify="end" 
        hidden = {(internalStatus===CONSTANTS.CLAIM_STATUS.INTERNAL_STATUS.APPROVED)||
          ...
          (internalStatus===CONSTANTS.CLAIM_STATUS.INTERNAL_STATUS.INVALID) ||
          (internalStatus===CONSTANTS.CLAIM_STATUS.INTERNAL_STATUS.SETTLED) || 
          userType === CONSTANTS.MAN_USER_TYPES.ADMIN 
        }
      >
        <Button
          type="primary"
